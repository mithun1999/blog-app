    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <div class="col-sm-8 ">
          ...
          <h1 class="lead">The Complete blog by using PHP by MithunKumar</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
...
<br>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          <div class="col">
          <p class="lead text-center">Theme By | Mithun Kumar | <span id="year"></span> &copy; ----All right Reserved.</p>
           </div>
         </div>
      </div>
    </footer>
